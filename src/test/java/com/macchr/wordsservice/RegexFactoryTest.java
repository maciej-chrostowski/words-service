...
class RegexFactoryTest {
    ...
    @Test
    public void createCorrectRegexFromLetters() {
    ...
    @Test
    public void createCorrectRegexFromContaining() {
        var characters = "abcaab";
        String regex = regexFactory.containing(characters);
        ...
        assertThat(fromOpenSquareBracket).contains("b");
        assertThat(fromOpenSquareBracket).contains("c");
        assertThat(fromOpenSquareBracket).contains("{1,6}");
    }
